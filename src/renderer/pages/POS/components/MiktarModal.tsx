...
export const MiktarModal = React.memo(function MiktarModal({ isOpen, onClose, onConfirm, maxMiktar, urunAdi, mevcutMiktar = 0 }: MiktarModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="relative z-50 isolate flex flex-col gap-2 sm:gap-2.5 bg-[#171410] text-slate-100 select-none overflow-y-auto pos-scrollbar max-h-[85vh] p-1"
      ...
      >
        ...
        <div className="flex items-center justify-between p-2 sm:p-2.5 rounded-xl bg-[#1e1a16] border border-[#3A342C] flex-shrink-0 shrink-0">
          ...
          <span className={clsx(
            ...
            hataAnimasyonu 
              ...
              : "bg-[#110F0C] text-slate-400 border-[#322C26]"
          )}>
            Maks: {maxMiktar} Adet
          </span>
        </div>
            ...
            <button
              ...
              className={clsx(
                ...
                girilenDeger === val 
                  ...
                  : "bg-[#1e1a16] text-slate-300 border-[#3A342C] hover:bg-[#322C26] disabled:opacity-30"
              )}
            >
              {val}
            </button>
          ...
          <button
            ...
            className={clsx(
              ...
              girilenDeger === maxMiktar.toString()
                ...
                : "bg-[#1e1a16] text-amber-400 border-[#3A342C] hover:bg-[#322C26]"
            )}
          >
            Tümü
          </button>
        ...
        <div className="bg-[#110F0C] p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-[#322C26] flex flex-col items-center justify-center mx-auto w-full max-w-xs shadow-inner flex-shrink-0 shrink-0">
          <div className="mb-1.5 text-center w-full">
            <input
              ...
              className="w-full h-10 sm:h-12 text-center bg-[#171410] rounded-xl border border-[#3A342C] font-mono font-black text-xl sm:text-2xl text-cyan-400 shadow-inner focus:outline-none focus:border-cyan-500 transition-colors"
            />
          </div>
        ...
        {/* Aksiyon Butonları */}
        <div className="flex justify-end gap-2 sm:gap-2.5 mt-0.5 pt-2 sm:pt-2.5 border-t border-[#322C26] flex-shrink-0 shrink-0">
          <Button 
            variant="ghost" 
            size="md" 
            onClick={onClose} 
