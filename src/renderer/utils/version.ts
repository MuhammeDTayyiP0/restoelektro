...
/**
 * package.json'dan otomatik olarak derlenen sürüm numarası (Örn: "2.3.0")
 */
export const APP_VERSION: string =
  typeof __APP_VERSION__ !== 'undefined' ? __APP_VERSION__ : '2.3.0'

/**
 * Sürüm etiketi (Örn: "v2.3.0")
 */
export const APP_VERSION_TAG: string = `v${APP_VERSION}`

/**
 * Tam sürüm başlığı (Örn: "ETİBOL POS v2.3.0")
 */
